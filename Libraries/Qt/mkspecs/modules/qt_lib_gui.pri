...
QT_CONFIG += accessibility accessibility-atspi-bridge action clipboard colornames cssparser cursor desktopservices imageformat_xpm draganddrop opengl egl freetype fontconfig harfbuzz highdpiscaling ico im image_heuristic_mask image_text imageformat_bmp imageformat_jpeg imageformat_png imageformat_ppm imageformat_xbm imageformatplugin kms movie pdf picture sessionmanager shortcut standarditemmodel systemtrayicon tabletevent texthtmlparser textodfwriter validator wheelevent xrender
QT_MODULES += gui
